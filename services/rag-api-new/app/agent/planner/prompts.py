...
1. graph_query_tool - для структурированных запросов с конкретной сущностью
   ...
   - "ml_framework" - ML фреймворки (LangChain, LangGraph, vLLM, Ultralytics и т.д.)
   - "mlops" - MLOps инструменты (MLFlow, LiteLLM и т.д.)
...
Вопрос: "Контакты Дмитрия" / "Как связаться с Дмитрием?"
{
  "intents": ["contacts"],
  "entities": [],
